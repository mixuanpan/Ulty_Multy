...
*   [CALCULATIONS](#11)
*   [](#12)
*   [FORMATTED TEXT & FIGURE DISPLAYS](#13)
*   [](#14)
*   [Initialization](#17)
*   [ip\_brain\_plot.m](#18)
*   [ip\_subject\_info.m](#19)
*   [ip\_data\_filter](#20)
*   [ip\_time\_frequency\_analysis.m](#21)
...
Error in commenting\_all>ip\_welcome (line 78)
    consent = input("Do you allow this tool to perform data analysis (y/n)? ", "s");
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
filter each subject data with the bandwith given to the target subject
